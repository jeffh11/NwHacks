    ...
    <main className="min-h-screen flex flex-col items-center bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <nav className="w-full flex justify-center border-b h-20 bg-white shadow-sm">
        <div className="w-full max-w-5xl flex justify-between items-center px-8 text-xl">
          ...
          <span className="font-extrabold text-4xl tracking-tighter text-amber-900">Huddle</span>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center gap-8 px-8 max-w-2xl">
        ...
        <Link
          href="/protected"
          className="px-8 py-4 rounded-xl bg-orange-500 text-white text-xl font-bold shadow-md hover:opacity-90 transition"
        >
